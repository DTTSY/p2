...
dataset = {
    ...
    'SMK_CAN_187': {'k': 2, 'data': ld.load_SMK_CAN_187},
    'GLI_85': {'k': 2, 'data': ld.load_GLI_85},
    'Brain_Tumor1':{'k':2,'data':ld.load_Brain_Tumor1},
    'UPS':{'k':10,'data':ld.load_usps},
    'TOX':{'k':4,'data':ld.load_TOX},
    'semeion':{'k':10,'data':ld.load_semeion},
    'fashion_mnist':{'k':10,'data':ld.load_mnist_10000},
#    'semeion':{'k':10,'data':ld.load_semeion}
    "cifar" :{'k':10,'data':ld.unpickle_cifar},
    "drift":{'k': 6,"data":ld.drift_load}
